...
<%  String input=request.getParameter("p");
	...
	try{
		...
		Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/onlinefoodorderdb","root","Prab@2000");  
			...
			Statement st=con.createStatement();
   			...
   			if (session.getAttribute("order_id_key")==null)
   			{
				...
				System.out.println("Order_id     "+order_id);
				   //order_id=1;		
   				rs_temp=sts.executeQuery("select max(FO_id) from foodorder ");
                                rs_temp.next();
   				...
   				{	
   					...
   					//session.setAttribute("order_id", order_id); 
   						...
   						ps.setInt(4, totalPrice);
                                                ...
                                                System.out.println("foodOrder_id"+food_id);
   						System.out.println("Order_id"+order_id);
